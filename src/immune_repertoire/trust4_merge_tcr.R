...
option_list = list(
  make_option(c("-f", "--tcr"), type="character", default=NULL,
...
tcr <- merge_process(filelist.samples)
write.table(tcr, paste(outdir,Condition,"_",Treatment,"_vs_",Control,"_TRUST4_TCR.txt",sep=''),sep = '\t',quote=FALSE,row.names = FALSE)
