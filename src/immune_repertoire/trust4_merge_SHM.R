...
option_list = list(
  make_option(c("-f", "--shm"), type="character", default=NULL,
...
SHM <- merge_process(filelist.samples)
write.table(SHM, paste(outdir,Condition,"_",Treatment,"_vs_",Control,"_TRUST4_BCR_SHMRatio.txt",sep=''),sep = '\t',quote=FALSE,row.names = FALSE)
