...
ggplot(merge.fusion.df, aes(x=Phenotype, y=log10(Expression+1))) + 
  ...
  theme_bw()+
  scale_colour_manual(name = "Type", values = c(Oncogene="#a6bddb",Tumor_Suppressor="#99d8c9", Both="#4DAF4A",Cancer_Driver="grey", Others = "grey"))+
  new_scale_color() +
  ...
  scale_fill_manual(values = c(Oncogene="#a6bddb",Tumor_Suppressor="#99d8c9", Both="#4DAF4A",Cancer_Driver="grey", Others = "grey"),guide = FALSE)+
