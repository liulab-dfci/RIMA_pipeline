...
colnames(hla_table)<- c("subject","|  A1  | ","|  A2  | ","|  B1  | ","|  B2  | ","|  C1  | ","|  C2  | ","|  DQA11  | ","| DQA12  | ","|  DQB11  | ","|  DQB12  | ","|  DRB11  | ","|  DRB12  | ")
write.csv(hla_table, file = paste(opt$multiqc, "hla_table.csv", sep = ""), row.names = FALSE)
