...
###test
# data <- read.table(file = "~/Documents/pipeline_test/files/star/STAR_Align_Report.csv", sep=",", header=TRUE, check.names=FALSE, row.names = 1)
...
#png(file = "~/Documents/pipeline_test/images/star/STAR_Align_Report.png", res = 300, width = Pwidth, height = 1500)
map_stat(data = data)
dev.off()
