...
multiqc_heatmap <- cbind(rownames(multiqc_heatmap), multiqc_heatmap)
write.table(multiqc_heatmap, paste(mul_folder, "Microbiome_abundance_ratio.txt", sep = ""), row.names = FALSE, quote = FALSE, sep = "\t")
...
#multiqc_R <- subset(multiqc, Responder == "R")
#multiqc_NR <- subset(multiqc, Responder == "NR")
...
write.table(multiqc_matrix, paste(mul_folder, "Microbiome_abundance.txt", sep = ""), row.names = FALSE, quote = FALSE, sep = "\t")
