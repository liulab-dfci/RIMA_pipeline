...
png(file = paste(outdir,"TRUST4_BCR_heavy_metrics_plot.png",sep = ""),res = 300, width = 2200, height = 550)
#cowplot::plot_grid(gr,gc,gs,gn, nrow = 1)
if(nrow(gs$data) == 0) {
  gs <- NULL
}
...
png(file = paste(outdir,"TRUST4_TCR_metrics_plot.png",sep = ""),res = 300, width = 2200, height = 550)
par(oma=c(1,1,1,1))
